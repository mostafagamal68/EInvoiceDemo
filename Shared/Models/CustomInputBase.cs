...
public abstract class CustomInputBase<TValue> : ComponentBase, IDisposable
{
    ...
    protected string CssClass
    {
        get
        {
            ...
            return CustomAttributeUtilities.CombineClassNames(AdditionalAttributes, fieldClass) ?? string.Empty;
        }
    }
